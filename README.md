...
- 📋 Устройства из DHCP аренды (даже если сейчас не подключены к WiFi)
- ⛔ Блокировка/разблокировка устройств по MAC
- 🔒 Блокировка всех устройств (кроме белого списка)
- ⚪ Белый список
- ➕ Ручное добавление устройства в белый список по MAC-адресу
...
- 📅 Быстрый выбор дней в расписании (все дни / будни / выходные)
- ⚠️ Проверка конфликтов пересекающихся интервалов расписания
